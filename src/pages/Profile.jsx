...
export default function Profile() {
  ...
  const handleSupabaseSetup = () => {
    toast({
      ...
      description:
        "To enable persistent storage, please connect your Supabase account through the integration settings.",
    });
  };

  const memberSince = (() => {
    if (!user?.createdAt) return "No data held";
    const d = new Date(user.createdAt);
    if (Number.isNaN(d.getTime())) return "No data held";
  ...
  return (
    <Layout>
      ...
      {/* ✅ PHONE-FRAME FRIENDLY: don't use max-w-* wrappers */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="font-semibold truncate">{user?.email || "No data held"}</div>
              </div>
            </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Your data is currently stored locally in your browser using localStorage. For production use with
                persistent storage across devices, connect Supabase.
              </p>
              <Button
