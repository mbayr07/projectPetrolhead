...
export default function Signup() {
  ...
  const handleSubmit = (e) => {
    ...
    toast({
      ...
      description: "Welcome to Vehicle Guardian.",
    });
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Create your Vehicle Guardian account to start managing your vehicles with automated reminders and document storage."
        />
      </Helmet>
